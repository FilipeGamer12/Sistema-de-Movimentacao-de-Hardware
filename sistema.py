# (arquivo completo) test.py — atualização: selects do modal escuros + date_to predefinido ao abrir modal
import json
import csv
import datetime
...
RESPONSAVEIS = [
    "Adriano Nauck",
    "Angela Maria Leite dos Santos",
    "Edson Araujo da Silva",
    "Eduardo Molodowski Oliveira",
    "Filipe de Paula Schaurich",
    "Filipe Roviero Ronca",
    "Gabriel Torrens Silva",
    "Joao Gualberto Boissa Netto",
    "Joao Pedro Gomes Kinap",
    "Joao Pedro Nicolau de Faria",
    "Kaiube Henrique Pertile",
    "Paulo Afonso Cordova Miranda",
    "Pietro Pra Giacomitti",
    "Sirlei Wieczorkowski Alexandre"
]
  ...
  <div class="modal-inner">
    ...
    <form id="form_export" method="GET" action="/export_csv" style="display:flex;flex-direction:column;gap:12px;">
      <div class="export-grid">
        <div class="export-left"><label><input type="checkbox" name="f_all" id="f_all"> <span>Todos</span></label></div>
        <div class="export-right"><div class="note">Selecionar para exportar todos os registros</div></div>

        <div class="export-left"><label><input type="checkbox" name="f_manual" id="f_manual"> <span>Manual</span></label></div>
        <div class="export-right"><div class="note">Exporta apenas os registros visíveis na tabela</div></div>
